...
int main(int argc, char *argv[]) {
    ...
    double area, perimetro = 0; //Utilizzo il tipo double dato che � richiesto dalla funzione pow della libreria math.h
	...
	printf("e che � presente un angolo di 90�\n\n");
	...
	do {
		...
		switch(tipo) {
			...
			case 'S': case 's':
				...
				//In questo caso, calcolo prima il perimetro, dato che � richiesto dalla formula di Erone
			...
			case 'R': case 'r':
				...
				area = lato1 * lato3 / 2; //Lato 3 in questo caso � l'altezza, quindi uso la formula generica per l'area
			...
			default:
				printf("Tipologia inserita non valida. Riprova.\n");
				tipoValido = false;
